...
_Auto-generated by [Trivy](https://github.com/aquasecurity/trivy) on every push and weekly scan — the scanner version shown in the dashboard header is captured live from each run, never hand-typed here._
<!-- TRIVY_SECURITY_END -->
